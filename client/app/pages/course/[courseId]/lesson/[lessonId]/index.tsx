                ...
                <Box className="bg-white lesson-page">
                    <Grid container>
                        <Grid item container md={9} xs={8}>
                            <Grid item container md={12} xs={12} style={{ height: "3rem" }}>
