    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deadline', models.DateTimeField(default=django.utils.timezone.now, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_image', models.ImageField(default='course/default.png', null=True, upload_to=api.models.upload_to, verbose_name='Image')),
                ('course_file', models.FileField(blank=True, null=True, upload_to=api.models.upload_to)),
                ('is_closed', models.IntegerField(choices=[(1, 'yes'), (0, 'no')], default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assignment_form_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='assignment_questions', to='api.assignmentform')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='assignment_answer', to='api.assignmentquestion')),
                ('student_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.student')),
            ],
        ),
    ]
